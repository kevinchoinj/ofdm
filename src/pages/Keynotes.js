...
class Keynotes extends React.Component{
    ...
    this.props.pagesActions.setPage("Keynotes");
		...
		const scrollbar = Scrollbar.init(document.querySelector('#keynotes_wrapper'), {
  ...
  render(){
    ...
    return(
      <div id="keynotes_wrapper" className={wrapperName}>
        ...
        <div className="keynotes_container">
          <KeynoteSection year="2015" toggleDisplay = {this.toggleDisplay}>
          ...
          <KeynoteSection year="2013" toggleDisplay = {this.toggleDisplay}>
          ...
          <KeynoteSection year="2012" toggleDisplay = {this.toggleDisplay}>
